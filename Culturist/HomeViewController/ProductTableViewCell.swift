    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if let homeViewController = parentViewController() {
            ...
            if productIndexPath == 1 {
                ...
                firebaseManager.addRecommendData(exhibitionUid: artProducts1[indexPath.item].uid, title: artProducts1[indexPath.item].title, location: artProducts1[indexPath.item].showInfo[0].location, locationName: artProducts1[indexPath.item].showInfo[0].locationName)
            } else if productIndexPath == 2 {
                detailVC.detailDesctription = artProducts6[indexPath.item]
                firebaseManager.addRecommendData(exhibitionUid: artProducts6[indexPath.row].uid, title: artProducts6[indexPath.item].title, location: artProducts6[indexPath.item].showInfo[0].location, locationName: artProducts6[indexPath.item].showInfo[0].locationName)
            }
